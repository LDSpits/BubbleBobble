...
public class TutorialManager : MonoBehaviour {
    ...
    void Update() {
        if (currentMission == 0 && InputManager.Left(PlayerID.player1) || InputManager.Right(PlayerID.player1)) { //Missie: Bewegen
            CompleteMission(0);
        }

        if (currentMission <= 1 && InputManager.Jump(PlayerID.player1)) { //Missie: Springen
